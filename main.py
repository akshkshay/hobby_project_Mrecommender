...
# converting list of numbers to list (eg. "[1,2,3]" to [1,2,3])
...
def recommend():
    ...
    # calling the convert_to_list function for every string that needs to be converted to list
    ...
    # converting string to list (eg. "[1,2,3]" to [1,2,3])
